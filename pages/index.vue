    ...
    >
      ...
      >
        ...
        <div
          ref="heroFrameRef"
          :class="[
            'group relative mx-auto w-full max-w-xs shrink-0 overflow-hidden rounded-xl border border-[hsl(var(--tac-amber)/0.3)] bg-black sm:max-w-sm lg:mx-0 lg:w-[30rem]',
