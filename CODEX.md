...
Preferred model workflow for DEAFCS:
- investigation/planning: Sol High
- implementation: Luna
- final review: Sol High
- small/simple tasks may use Luna alone

Do not assume the model can silently switch itself; follow the selected session/model context.
